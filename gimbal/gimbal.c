...
void gimbal_init(void)
{
    ...
    gimbal.pitch_motor.speed = 0x0FFF; // 初始速度
    ...
    gimbal.yaw_motor.speed = 0x0FFF; // 初始速度
...
{
    gimbal.pitch_motor.angle = gimbal.pitch; // 假设每度对应10
    gimbal.yaw_motor.angle = gimbal.yaw; // 假设每度对应10
    // 设置俯仰电机和偏航电机的角度
