...
#include "ZDT_drive.h"
#include "vision.h"
#define OFFSET_PITCH_SCALE 0.002 // 差值换算
#define OFFSET_YAW_SCALE 0.002 // 差值换算
// 在头文件中添加限位宏
#define GIMBAL_ANGLE_MAX    7200
#define GIMBAL_ANGLE_MIN   -7200
#define GIMBAL_PITCH_MAX   1800
#define GIMBAL_PITCH_MIN   -1800
#define GIMBAL_YAW_MAX     450
#define GIMBAL_YAW_MIN    -450
// 限位宏函数
#define LIMIT_ANGLE(value, min, max) \
    ((value) > (max) ? (max) : ((value) < (min) ? (min) : (value)))
//速度
#define GIMBAL_PITCH_SPEED 0x0160 // 352
#define GIMBAL_PITCH_ACCELERATION 0x0B00 // 2816
#define GIMBAL_YAW_SPEED 0x0160 // 352
#define GIMBAL_YAW_ACCELERATION 0x0600 // 2816
typedef struct {
    int16_t pitch;  // 俯仰角度
    int16_t yaw;    // 偏航角度
