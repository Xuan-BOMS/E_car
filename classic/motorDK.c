...
void motor_setSpeed(void) {
    ...
    if(MotorSpeed.Motor_Left_Speed > 0) {
        DL_TimerG_setCaptureCompareValue(PWM_MotorL_INST, MotorSpeed.Motor_Left_Speed, GPIO_PWM_MotorL_C0_IDX); // 设置左电机正转
        ...
        DL_TimerG_setCaptureCompareValue(PWM_MotorL_INST, -MotorSpeed.Motor_Left_Speed, GPIO_PWM_MotorL_C1_IDX); // 设置左电机反转
        DL_TimerG_setCaptureCompareValue(PWM_MotorL_INST, 0, GPIO_PWM_MotorL_C0_IDX); // 停止左电机正转
    }
    if(MotorSpeed.Motor_Right_Speed > 0) {
        DL_TimerG_setCaptureCompareValue(PWM_MotorR_INST, MotorSpeed.Motor_Right_Speed, GPIO_PWM_MotorR_C0_IDX); // 设置右电机正转
        ...
        DL_TimerG_setCaptureCompareValue(PWM_MotorR_INST, -MotorSpeed.Motor_Right_Speed, GPIO_PWM_MotorR_C1_IDX); // 设置右电机反转
