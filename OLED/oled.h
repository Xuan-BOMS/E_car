...
typedef struct
{
	union
	{
		...
		struct
		{
			...
			uint32_t fmt_x			:8;		//格式化起点x
			uint32_t fmt_y			:8;		//格式化起点y
...
//OLED_USE_IIC:		使用IIC通信
//OLED_USE_SPI:		使用SPI通信
